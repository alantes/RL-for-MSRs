...
class Environment(gym.Env):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self.policy_generator = DesignedPolicy(int((1/frequency)/(self.num_steps_per_update*self.h_time_step)), self.maximum_magnetic_field_amp) #多少个 0.001s 一个周期，20Hz对应 50
    ...
    def reset(self):
        ...
        self.external_magnetic_field[:] = self.magnetic_field_generator.random_reset()
    ...
    def step(self, action):
        ...
        #reward -= 0.0002 * np.abs(self.shearable_rod.velocity_collection.copy()[..., 32][1])
